...
public class CreateMeetingAgendaViewModel extends ViewModel {
    private CreateMeetingAgendaUseCase useCase = new CreateMeetingAgendaUseCase();
    private GetCurrentUserUseCase getCurrentUserUseCase = new GetCurrentUserUseCase();
